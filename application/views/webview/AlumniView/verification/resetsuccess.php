      ...
      <div class="notifhead">
        <div class="col-md-12 d-flex justify-content-center">
          <div class="card d-flex align-items-center mt-3">
            ...
            <p class="mt-3">Reset password berhasil , silahkan cek email untuk mendapatkan password sementara</p>
            <button  type="submit" class="btn btnemailnotif"><a href="https://www.gmail.com">Ke email</a> </button>
          </div>
        </div>
